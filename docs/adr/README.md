...
| [ADR-009](ADR-009-neon-shared-email-nonproduction.md) | Accepted | E-mail compartilhado do Neon Auth em desenvolvimento/non-production; provedor externo adiado até necessidade real | `US-AUTH-004` |
