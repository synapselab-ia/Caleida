...
export default function AccountPrivacyError({ reset }: { reset: () => void }) {
  return (
    <main className="min-h-dvh bg-background px-5 py-8 text-text-primary sm:px-8 lg:px-12">
      <div className="mx-auto grid min-h-[70dvh] w-full max-w-2xl content-center gap-6">
        <Feedback kind="alert" title="Não foi possível abrir a privacidade">
          O Caleida não conseguiu carregar seus bloqueios. Nenhuma alteração foi aplicada.
        </Feedback>
