...
export default function AccountLifecycleError({ reset }: { reset: () => void }) {
  return (
    <main className="min-h-dvh bg-background px-5 py-8 text-text-primary sm:px-8 lg:px-12">
      <div className="mx-auto grid min-h-[70dvh] w-full max-w-2xl content-center gap-6">
        <Feedback kind="alert" title="Ciclo da conta indisponível">
          Não foi possível carregar o estado da conta. O acesso normal não é liberado sem essa validação.
        </Feedback>
